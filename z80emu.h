 ...
 *
 * Modified for CPMemu by R. Stange
 */
...
/* Here are macros for CPMemu. Read/write memory macros have been
 * written for a linear 64k RAM. Input/output port macros are
 * handled by the CZ80Ports class.
 */
